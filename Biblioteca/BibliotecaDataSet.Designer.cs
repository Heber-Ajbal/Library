...
namespace Biblioteca {
    ...
    public partial class BibliotecaDataSet : global::System.Data.DataSet {
        ...
        public partial class bookDataTable : global::System.Data.TypedTableBase<bookRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public bookRow AddbookRow(string name, int authorid) {
            ...
            public string name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'name\' de la tabla \'book\' es DBNull.", e);
                    }
                }
                set {
            ...
            public int authorid {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'authorid\' de la tabla \'book\' es DBNull.", e);
                    }
                }
                set {
    ...
    public partial class bookTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[book] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND " +
                "[name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_authorid = 1 AND [au" +
                "thorid] IS NULL) OR ([authorid] = @Original_authorid)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[book] ([name], [authorid]) VALUES (@name, @authorid);\r\nSELECT " +
                "id, name, authorid FROM book WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[book] SET [name] = @name, [authorid] = @authorid WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_authorid = 1 AND [authorid] IS NULL) OR ([authorid] = @Original_authorid)));
SELECT id, name, authorid FROM book WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, authorid FROM dbo.book";
        ...
        public virtual int Fill(BibliotecaDataSet.bookDataTable dataTable) {
        ...
        public virtual BibliotecaDataSet.bookDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BibliotecaDataSet.bookDataTable dataTable = new BibliotecaDataSet.bookDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BibliotecaDataSet.bookDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, global::System.Nullable<int> Original_authorid) {
        ...
        public virtual int Update(string name, global::System.Nullable<int> authorid, int Original_id, string Original_name, global::System.Nullable<int> Original_authorid, int id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, global::System.Nullable<int> authorid, int Original_id, string Original_name, global::System.Nullable<int> Original_authorid) {
